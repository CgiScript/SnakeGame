    ...
    Box(modifier = modifier) {
        Column(modifier = Modifier.fillMaxSize()) {
            Row (modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center){
                Button(onClick = {eventList[0]()}, shape = RectangleShape) {
                    Icon(
            ...
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
                Button(onClick = {eventList[1]()}, shape = RectangleShape) {
                    Icon(
                ...
                Button(onClick = {eventList[2]()}, shape = RectangleShape) {
                    Icon(
                        modifier = Modifier.size(50.dp),
            ...
            Spacer(modifier = Modifier.size(20.dp))
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center){
                Button(onClick = {eventList[3]()}, shape = RectangleShape) {
                    Icon(
                        modifier = Modifier.size(50.dp),
